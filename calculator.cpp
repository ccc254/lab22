...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	wc.hbrBackground = CreateSolidBrush(RGB(200, 0, 100)); //เปลี่ยนสี
	...
	hwnd = CreateWindowEx(
		...
		"WindowClass",
		"My Calculator", //ชื่อ
		WS_VISIBLE|WS_OVERLAPPEDWINDOW & ~WS_THICKFRAME & ~WS_MAXIMIZEBOX, //~WS_THICKFRAME เปลี่ยนขนาดไม่ได้ ~WS_MAXIMIZEBOX ย่อขยายไม่ได้
		CW_USEDEFAULT, /* x */
		CW_USEDEFAULT, /* y */
		250, /* width */
		200, /* height */
